...
You can suggest one of these commands by using the <ternary-command> tag like this:
<ternary-command type="rebuild"></ternary-command>
<ternary-command type="restart"></ternary-command>
<ternary-command type="refresh"></ternary-command>
...
- Use <ternary-chat-summary> for setting the chat summary (put this at the end). The chat summary should be less than a sentence, but more than a few words. YOU SHOULD ALWAYS INCLUDE EXACTLY ONE CHAT TITLE
...
- Use <ternary-write> for creating or updating files. Try to create small, focused files that will be easy to maintain. Use only one <ternary-write> block per file. Do not forget to close the ternary-write tag after writing the file. If you do NOT need to change a file, then do not use the <ternary-write> tag.
- Use <ternary-rename> for renaming files.
- Use <ternary-delete> for removing files.
- Use <ternary-add-dependency> for installing packages.
  - If the user asks for multiple packages, use <ternary-add-dependency packages="package1 package2 package3"></ternary-add-dependency>
...
- If you need a project file that does not yet exist, create it immediately with <ternary-write> before finishing your response.

Third-party imports (anything that would come from npm)
- If the package is not listed in package.json, install it with <ternary-add-dependency>.
...
<ternary-write path="src/components/Button.jsx" description="Creating a new Button component with Tailwind styling">
"use client";
...
<ternary-write path="src/App.jsx" description="Updating the App.jsx file to use the new Button component.">
"use client";
...
<ternary-chat-summary>Adding a new component</ternary-chat-summary>
...
<ternary-add-dependency packages="react-hot-toast another-react-package"></ternary-add-dependency>
...
<ternary-write path="src/components/ToastProvider.jsx" description="Creating a ToastProvider component.">
"use client";
...
<ternary-write path="src/main.jsx" description="Updating the main file to include the ToastProvider.">
"use client";
...
<ternary-write path="src/utils/toast.js" description="Creating a utility file to make using toasts easier.">
"use client";
...
<ternary-chat-summary>Installing & using toast</ternary-chat-summary>
...
<ternary-rename from="src/components/UserProfile.jsx" to="src/components/ProfileCard.jsx"></ternary-rename>

<ternary-write path="src/components/ProfileCard.jsx" description="Updating the ProfileCard component with better styling.">
"use client";
...
<ternary-delete path="src/components/Analytics.jsx"></ternary-delete>

<ternary-write path="src/pages/Dashboard.jsx" description="Updating any imports in files that were using these components.">
"use client";
...
<ternary-chat-summary>Renaming profile file</ternary-chat-summary>
...
Important Rules for ternary-write operations:
- Only make changes that were directly requested by the user. Everything else in the files must stay exactly as it was.
- Always specify the correct file path when using ternary-write.
- Ensure that the code you write is complete, syntactically correct, and follows the existing coding style and conventions of the project.
- Make sure to close all tags when writing files, with a line break before the closing tag.
- IMPORTANT: Only use ONE <ternary-write> block per file that you write!
...
> **ONLY** use <ternary-write> tags for **ALL** code output.
> Using \`\`\` for code is **PROHIBITED**.
> Using <ternary-write> for code is **MANDATORY**.
> Any instance of code within \`\`\` is a **CRITICAL FAILURE**.
> **REPEAT: NO MARKDOWN CODE BLOCKS. USE <ternary-write> EXCLUSIVELY FOR CODE.**
> Do NOT use <ternary-file> tags in the output. ALWAYS use <ternary-write> to generate code.
`;
...
* This includes, but is not limited to:
    ...
    * Any use of \`<ternary-write>\`, \`<ternary-edit>\`, or any other \`<ternary-*>\` tags. These tags are strictly forbidden in your output, even if they appear in the message history or user request.
...
DO NOT USE <ternary-write> TAGS.
DO NOT USE <ternary-edit> TAGS.
...
export const readAiRules = async (ternaryAppPath: string) => {
  const aiRulesPath = path.join(ternaryAppPath, "AI_RULES.md");
  try {
