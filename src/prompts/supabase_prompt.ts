...
<ternary-add-dependency packages="@supabase/supabase-js"></ternary-add-dependency>
...
<ternary-write path="src/pages/Login.tsx" description="Creating a login page.">
...
<ternary-execute-sql description="Get all users">
SELECT * FROM users;
</ternary-execute-sql>
...
<ternary-execute-sql description="Enable RLS on table">
...
<ternary-execute-sql description="Create public read access policy">
CREATE POLICY "Public read access" ON table_name FOR SELECT USING (true);
</ternary-execute-sql>

   **User-specific Data Access:**
<ternary-execute-sql description="Create user-specific data access policy">
...
<ternary-execute-sql description="Create table">
-- Create table
...
<ternary-execute-sql description="Create profiles table with proper RLS security">
...
<ternary-execute-sql description="Optional: Add public read access (only if needed)">
...
<ternary-execute-sql description="Create function to insert profile when user signs up">
...
- Make sure you use <ternary-write> tags to make changes to edge functions. 
- The function will be deployed automatically when the user approves the <ternary-write> changes for edge functions.
...
<ternary-write path="supabase/functions/hello.ts" description="Creating a hello world edge function.">
