...
export const SMART_CONTEXT_PROMO_MESSAGE: MessageConfig = {
  spans: [
    ...
    {
      type: "link",
      content: "Ternary Pro's Smart Context",
      url: "https://ternary.sh/pro#ai",
    },
  ],
};
...
export const REDDIT_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      ...
      url: "https://www.reddit.com/r/ternarybuilders/",
    },
  ],
};
...
export const BUILD_A_BIBLE_APP_TIP: MessageConfig = {
  spans: [
    ...
    {
      type: "text",
      content: " the creator of Ternary build a Bible app step-by-step",
    },
  ],
};
...
export const DEBUGGING_TIPS_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      ...
      url: "https://www.ternary.sh/docs/guides/debugging",
    },
  ],
};

// Advanced tip: Customize your AI rules https://www.ternary.sh/docs/guides/ai-rules
export const AI_RULES_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "AI rules",
      url: "https://www.ternary.sh/docs/guides/ai-rules",
    },
  ],
};
...
// Want to know what's next? Checkout our roadmap https://www.ternary.sh/docs/roadmap
export const ROADMAP_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "roadmap",
      url: "https://www.ternary.sh/docs/roadmap",
    },
  ],
};

// Like Ternary? Star it on GitHub https://github.com/ternary-std/ternary/
export const GITHUB_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "GitHub",
      url: "https://github.com/ternary-std/ternary",
    },
  ],
};
