...
import { hasTernaryProKey } from "@/lib/schemas";
...
export function ProModeSelector() {
  ...
  const toggleProEnabled = () => {
    updateSettings({
      enableTernaryPro: !settings?.enableTernaryPro,
    });
  };
  ...
  return (
    <Popover>
      <Tooltip>
        ...
        <TooltipContent>Configure Ternary Pro settings</TooltipContent>
      </Tooltip>
        ...
        <div className="space-y-4">
          <div className="space-y-1">
            <h4 className="font-medium flex items-center gap-1.5">
              <Sparkles className="h-4 w-4 text-primary" />
              <span className="text-primary font-medium">Ternary Pro</span>
            </h4>
              ...
              <a
                ...
                onClick={() => {
                  IpcClient.getInstance().openExternalUrl(
                    "https://ternary-premium-x2m1.vercel.app/",
                  );
                }}
              >
                Unlock Pro modes
